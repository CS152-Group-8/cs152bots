...
def is_message_sextortion(message: str):
    response = openai.ChatCompletion.create(
        ...
        messages=[
            ...
            },
            {
                "role": "user",
                "content": (
                    "If you don't send me nude photos within the next 24 hours, I"
                    " will post all your private information, including your"
                    " address and phone number, online for everyone to see. I can"
                    " assure you, the humiliation and consequences will be"
                    " unbearable. It's your choice – send the pictures or suffer"
                    " the repercussions"
                ),
            },
...
def is_message_encouraging_self_harm(message: str):
    response = openai.ChatCompletion.create(
        model="gpt-4",
        messages=[
            {
                "role": "system",
                "content": (
                    "You are a system designed to detect messages involving self-harm."
                    " Classify each input as either True or False."
                ),
            },
